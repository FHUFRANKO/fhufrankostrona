...
// === INSERT: SSR Ogłoszenia ===
import { createClient } from "@supabase/supabase-js";
/* ===== SSR Ogłoszenia – dynamicznie z Supabase ===== */
...
function render(list){
  ...
  <style>
    ...
    .card{background:#13161b;border:1px solid #1f232a;border-radius:12px;overflow:hidden;display:flex;flex-direction:column}
    .thumb{width:100%;aspect-ratio:16/9;object-fit:cover;background:#0e1116}
    .body{padding:12px}
    h3{margin:0 0 8px;font-size:18px;color:#fff}
    .meta{margin:0 0 6px;color:#9aa4b2;font-size:13px}
    .price{margin:0 0 8px;font-weight:700}
    .tags{margin:0;color:#9aa4b2;font-size:12px}
    ...
    <main class="wrap">
      ...
      `<div class="empty">Brak ogłoszeń w bazie Supabase.</div>`}
    </main>
  </body></html>`;
}
